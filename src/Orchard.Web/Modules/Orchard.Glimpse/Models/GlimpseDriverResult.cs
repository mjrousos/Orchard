...
namespace Orchard.Glimpse.Models {
    public class GlimpseDriverResult : DriverResult {
        ...
        public override void Apply(BuildDisplayContext context) {
            _glimpseService.PublishTimedAction(
                ...
                TimelineCategories.Parts,
                "Display Part: " + (ContentPart == null ? context.ContentItem.ContentType : ContentPart.PartDefinition.Name),
                context.ContentItem.GetContentName()
            );
        }
