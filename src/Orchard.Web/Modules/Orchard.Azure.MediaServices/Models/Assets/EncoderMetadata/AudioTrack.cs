...
namespace Orchard.Azure.MediaServices.Models.Assets.EncoderMetadata {
    public class AudioTrack {
        ...
        /// <summary>
        /// The average audio bitrate in bits per second, as calculated from the media file.
        /// Takes into consideration only the elementary stream payload and does not include the packaging overhead.
        /// </summary>
        public int Bitrate {
            get {
