...
namespace Orchard.Layouts.Services {
    public class LayoutManager : ILayoutManager {
        ...
        public IEnumerable<LayoutPart> GetLayouts() {
            var layoutTypeNamesQuery = from typeDefinition in _contentManager.GetContentTypeDefinitions()
                                     from typePartDefinition in typeDefinition.Parts
                                     where typePartDefinition.PartDefinition.Name == "LayoutPart"
                                     select typeDefinition.Name;

            var layoutTypeNames = layoutTypeNamesQuery.ToArray();
            return _contentManager.Query<LayoutPart>(layoutTypeNames).List();
        }
        ...
        public IEnumerable<LayoutPart> GetTemplateClients(int templateId, VersionOptions versionOptions) {
            return _contentManager.Query<LayoutPart, LayoutPartRecord>(versionOptions)
