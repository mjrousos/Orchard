...
namespace NHibernate.Linq.Util
{
    ...
    public class DetachedCriteriaAdapter : ICriteria
    {
        ...
        {
            get { return _readOnlyInitialized; }
        }
        ...
        public Task<IList> ListAsync(CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }

        public Task<object> UniqueResultAsync(CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }

        public Task ListAsync(IList results, CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }

        public Task<IList<T>> ListAsync<T>(CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }

        public Task<T> UniqueResultAsync<T>(CancellationToken cancellationToken = default)
        {
            throw new NotSupportedException();
        }
